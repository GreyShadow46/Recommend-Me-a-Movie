  ...
  con.connect(function(err) {
    ...
    con.query("SELECT * FROM accounts WHERE userName = '" + req.body.username + "' AND emailAddress = '" + req.body.email + "'", function (err, result, fields) {
      if(result.length !== 0){
        ...
        sendMail(username, req.body.email, "Reset Your Password", 'Please press this <a href="http://127.0.0.1:8080/resetyourpassword">button</a> to proceed');
        res.redirect('/verifyemail');
      }
      else {
...
app.post('/resetyourpassword', (req, res) => {
  ...
  con.connect(function(err) {
    if (err) throw err;
    console.log("Connected!");
    con.query("UPDATE accounts SET password = '" + CryptoJS.AES.encrypt(req.body.password, key) + "' WHERE userName = '" + username + "'", function (err, result, fields) {
      if(err) throw err
      console.log("1 record updated");
    })
    res.redirect('/signin')
...
app.get('/surveypage1', checkSignIn, function (req, res) {
  ...
  if(country === "United Kingdom") {
    data = '<meta name="viewport" content="width=device-width, initial-scale=1.0"><!DOCTYPE html><html><head><link rel="stylesheet" href="/styles.css" /><script src="/index.js"></script></head><body><div class="topBar"><div class="headerClass"><h1>Recommend Me a Movie</h1></div><div class="signUp"><p id="showUsername" class="signUpText"></p></div></div><div class="overview"><h2>Which Streaming Services do you own?</h2><p>Pick as many as you like</p><div><form action="/surveypage1" method="post"><div class="border"><div class="labelClass"><label for="netflix">Netflix</label></div><div class="checkboxClass"><input type="checkbox" id="netflix" name="netflix" /></div></div><br /><div class="border"><div class="labelClass"><label for="disneyplus">Disney +</label></div><div class="checkboxClass"><input type="checkbox" id="disneyplus" name="disneyplus" /></div></div><br /><div class="border"><div class="labelClass"><label for="amazonprime">Amazon Prime</label></div><div class="checkboxClass"><input type="checkbox" id="amazonprime" name="amazonprime" /></div></div><br /><div class="border"><div class="labelClass"><label for="nowtv">Now TV</label></div><div class="checkboxClass"><input type="checkbox" id="nowtv" name="nowtv" /></div></div><br /><div class="border"><div class="labelClass"><label for="appletv+">Apple TV +</label></div><div class="checkboxClass"><input type="checkbox" id="appletvplus" name="appletvplus" /></div></div><br /><div class="border"><div class="labelClass"><label for="paramountplus">Paramount+</label></div><div class="checkboxClass"><input type="checkbox" id="parmountplus" name="paramountplus" /></div></div><br /><input id="submitButton" name="submitButton" type="submit" value="Continue"/></form><br /><br /><br /><br /><br /><br /><br /><br /><br /></div></div><div class="topBar"><br /><br /><div class="signUp"><a class="signUpText" href="/unitedkingdom">United Kingdom</a><a class="signUpText" href="/unitedstates">United States</a><a class="signUpText" href="/australia">Australia</a></div></div></body></html>'
  }
  else if(country === "United States"){
    data = '<meta name="viewport" content="width=device-width, initial-scale=1.0"><!DOCTYPE html><html><head><link rel="stylesheet" href="/styles.css" /><script src="/index.js"></script></head><body><div class="topBar"><div class="headerClass"><h1>Recommend Me a Movie</h1></div><div class="signUp"><p id="showUsername" class="signUpText"></p></div></div><div class="overview"><h2>Which Streaming Services do you own?</h2><p>Pick as many as you like</p><div><form action="/surveypage1" method="post"><div class="border"><div class="labelClass"><label for="netflix">Netflix</label></div><div class="checkboxClass"><input type="checkbox" id="netflix" name="netflix" /></div></div><br /><div class="border"><div class="labelClass"><label for="disneyplus">Disney +</label></div><div class="checkboxClass"><input type="checkbox" id="disneyplus" name="disneyplus" /></div></div><br /><div class="border"><div class="labelClass"><label for="amazonprime">Amazon Prime</label></div><div class="checkboxClass"><input type="checkbox" id="amazonprime" name="amazonprime" /></div></div><br /><div class="border"><div class="labelClass"><label for="appletv+">Apple TV +</label></div><div class="checkboxClass"><input type="checkbox" id="appletvplus" name="appletvplus" /></div></div><br /><div class="border"><div class="labelClass"><label for="paramountplus">Paramount+</label></div><div class="checkboxClass"><input type="checkbox" id="parmountplus" name="paramountplus" /></div></div><br /><div class="border"><div class="labelClass"><label for="peacock">Peacock</label></div><div class="checkboxClass"><input type="checkbox" id="peacock" name="peacock" /></div></div><br /><div class="border"><div class="labelClass"><label for="max">Max</label></div><div class="checkboxClass"><input type="checkbox" id="max" name="max" /></div></div><br /><input id="submitButton" name="submitButton" type="submit" value="Continue"/></form><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /></div></div><div class="topBar"><br /><br /><div class="signUp"><a class="signUpText" href="/unitedkingdom">United Kingdom</a><a class="signUpText" href="/unitedstates">United States</a><a class="signUpText" href="/australia">Australia</a></div></div></body></html>'
  } else {
    data = '<meta name="viewport" content="width=device-width, initial-scale=1.0"><!DOCTYPE html><html><head><link rel="stylesheet" href="/styles.css" /><script src="/index.js"></script></head><body><div class="topBar"><div class="headerClass"><h1>Recommend Me a Movie</h1></div><div class="signUp"><p id="showUsername" class="signUpText"></p></div></div><div class="overview"><h2>Which Streaming Services do you own?</h2><p>Pick as many as you like</p><div><form action="/surveypage1" method="post"><div class="border"><div class="labelClass"><label for="netflix">Netflix</label></div><div class="checkboxClass"><input type="checkbox" id="netflix" name="netflix" /></div></div><br /><div class="border"><div class="labelClass"><label for="disneyplus">Disney +</label></div><div class="checkboxClass"><input type="checkbox" id="disneyplus" name="disneyplus" /></div></div><br /><div class="border"><div class="labelClass"><label for="amazonprime">Amazon Prime</label></div><div class="checkboxClass"><input type="checkbox" id="amazonprime" name="amazonprime" /></div></div><br /><div class="border"><div class="labelClass"><label for="appletv+">Apple TV +</label></div><div class="checkboxClass"><input type="checkbox" id="appletvplus" name="appletvplus" /></div></div><br /><div class="border"><div class="labelClass"><label for="paramountplus">Paramount+</label></div><div class="checkboxClass"><input type="checkbox" id="parmountplus" name="paramountplus" /></div></div><br /><input id="submitButton" name="submitButton" type="submit" value="Continue"/></form><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /></div></div><div class="topBar"><br /><br /><div class="signUp"><a class="signUpText" href="/unitedkingdom">United Kingdom</a><a class="signUpText" href="/unitedstates">United States</a><a class="signUpText" href="/australia">Australia</a></div></div></body></html>'
  }
...
app.post('/surveypage1', function (req, res) {
  ...
  con.connect(function(err) {
    ...
    con.query("SELECT * FROM streamingServices WHERE userName = '" + username + "'", function (err, result) {
      if(result.length !== 0){
        con.query("UPDATE streamingServices SET netflix = '" + (req.body.netflix ?? "") + "', disneyPlus = '" + (req.body.disneyplus ?? "") + "', amazonPrime = '" + (req.body.amazonprime ?? "") + "', nowTv = '" + (req.body.nowtv ?? "") + "', appleTvPlus = '" + (req.body.appletvplus ?? "") + "', paramountPlus = '" + (req.body.paramountplus ?? "") + "', peacock = '" + (req.body.peacock ?? "") + "', max = '" + (req.body.max ?? "") + "' WHERE userName = '" + username + "'", function (err, result) {
          if (err) throw err;
          console.log("1 record updated");
        });
      }
      else {
        con.query("INSERT INTO streamingServices (userName, netflix, disneyPlus, amazonPrime, nowTv, appleTvPlus, paramountPlus, peacock, max) VALUES ('" + (username ?? "") + "', '" + (req.body.netflix ?? "") + "', '" + (req.body.disneyplus ?? "") + "', '" + (req.body.amazonprime ?? "") + "', '" + (req.body.nowtv ?? "") + "', '" + (req.body.appletvplus ?? "") + "', '" + (req.body.paramountplus ?? "") + "', '" + (req.body.peacock ?? "") + "', '" + (req.body.max ?? "") + "')", function (err, result) {
          if (err) throw err;
          console.log("1 record inserted");
        });
      }
